...
lk.likelihood(kernel1,x,y,yerr)
print lk.gradient_likelihood(kernel1,x,y,yerr)

print 'test 2'
kernel2=kl.ExpSineSquared(10.1,1.2,5.1)
lk.likelihood(kernel2,x,y,yerr)
print lk.gradient_likelihood(kernel2,x,y,yerr)

print 'test 3'
kernel3=kl.ExpSquared(10.2,7.1)+kl.ExpSineSquared(10.1,1.2,5.1)
lk.likelihood(kernel3,x,y,yerr)
print lk.gradient_likelihood(kernel3,x,y,yerr)
print '#####################################'
...
### I need to check were the None comes from, I have now idea for now...
